...
const Modal: React.FC<IModal> = ({
  ...
  return (
    <div
      data-testid='modal'
      className={classNames('block w-full p-6 my-auto mx-auto text-left align-middle transition-all bg-white dark:bg-slate-800 text-black dark:text-white shadow-xl rounded-2xl pointer-events-auto max-h-[100dvh] overflow-y-auto overscroll-contain', widths[width])}
